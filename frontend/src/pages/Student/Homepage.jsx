      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 text-center">
          ...
          >
            ...
            <span className="text-sm font-medium">Admission for 2026 is now open</span>
          </motion.div>
          ...
          >
            ...
            Join us in our mission to provide world-class education and create tomorrow's leaders.
          </motion.p>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600 text-sm text-center">
                  Explore our {name} program designed to prepare students with practical skills and academic excellence.
                </p>
              </div>
            </motion.div>
          ))}
      ...
      <section id="contact" className="py-20 px-6 bg-white text-center">
        ...
        >
          ...
          <div className="bg-gray-50/50 rounded-xl p-6 border border-gray-100">
            ...
            <p className="text-red-600">General Santos Avenue, Central Bicutan, Taguig City</p>
          </div>
        </motion.div>
      </section>
    </div>
