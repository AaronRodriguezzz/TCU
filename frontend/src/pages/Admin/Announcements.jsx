...
import { Search, Eye, PenSquare, Trash2, Bell, ChevronDown } from "lucide-react";

const AnnouncementsPage = () => {
  const [search, setSearch] = useState("");
  const [typeFilter, setTypeFilter] = useState("All"); // e.g., General, Urgent

  const [announcements] = useState([
    { id: "AN-001", title: "Holiday Schedule", type: "General", date: "2024-11-01" },
    { id: "AN-002", title: "Exam Reschedule", type: "Urgent", date: "2024-11-05" },
    { id: "AN-003", title: "Library Hours", type: "General", date: "2024-11-03" },
  ]);
                  ...
                  filtered.map(a => (
                    <tr key={a.id} className="hover:bg-gray-50/50 transition-colors">
                      <td className="px-6 py-4 text-sm text-gray-700">
                        <span className="font-semibold text-red-600">{a.id}</span>
                      </td>
